...
# print(tup_ls,'Сумма цифр кортежа составляет=', sum(tup_ls))
...
for i in  set(long_word):
 print(i, long_word.count(i))  # функцию set() подсмотрел
...
st_first = 'Найти самое длинное слово в строке.' # НЕ ЗНАЮ ПОЧЕМУ ЗДЕСЬ ТАБУЛЯЦИЯ СБИЛАСЬ сейчас исправил, все норм!
st = st_first.split(' ')
longest_ind = []
world = ''
...
print(f"Самое длинное слово в строке это слово \"{st[l]}\"")


"""Задание №1 второй раз решал эту задачу, забыл удалить, СОРРИ!
...
#
# print(f"Самое длинное слово в строке это:{ls_a[ls_len.index(max(ls_len))]}")# ls_len.index(max(ls_len) определили индекс самого длинного числа
